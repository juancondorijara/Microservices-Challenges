...
public class Usuario {
    ...
    public Usuario(int IDUSU, String USUUSU, int NIVUSU, int IDCLI, int IDEMP, String NOMCLI, String APECLI, String EMACLI, String NOMEMP, String APEEMP, String EMAEMP, String ROLUSU, String ESTUSU, Cliente cliente, Empleado empleado) {
        this.IDUSU = IDUSU;
        this.USUUSU = USUUSU;
        this.NIVUSU = NIVUSU;
        this.IDCLI = IDCLI;
